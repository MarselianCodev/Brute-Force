#!/bin/bash
# FB by: https://www.youtube.com/channel/UCTLYdslUhjMu84kJ9g6Y6sw
# Instagram: @marselian.pedro
...
command -v openssl > /dev/null 2>&1 || { echo >&2 "Openssl'ye ihtiyacım var ama kurulu değil. İptal ediliyor."; exit 1; }
command -v tor > /dev/null 2>&1 || { echo >&2 "Tor'a ihtiyacım var ama kurulu değil. İptal ediliyor."; exit 1; }
command -v curl > /dev/null 2>&1 || { echo >&2 "Kıvrılmaya ihtiyacım var ama yüklü değil. İptal ediliyor."; exit 1; }
command -v awk > /dev/null 2>&1 || { echo >&2 "awk'ye ihtiyacım var ama kurulu değil. İptal ediliyor."; exit 1; }
command -v sed > /dev/null 2>&1 || { echo >&2 "sed'e ihtiyacım var ama kurulu değil. İptal ediliyor."; exit 1; }
command -v cat > /dev/null 2>&1 || { echo >&2 "Kediye ihtiyacım var ama kurulu değil. İptal ediliyor."; exit 1; }
command -v tr > /dev/null 2>&1 || { echo >&2 "tr'ye ihtiyacım var ama kurulu değil. İptal ediliyor."; exit 1; }
command -v wc > /dev/null 2>&1 || { echo >&2 "Wc istiyorum ama kurulu değil. İptal ediliyor."; exit 1; }
command -v cut > /dev/null 2>&1 || { echo >&2 "Kesmeye ihtiyacım var ama kurulu değil. İptal ediliyor."; exit 1; }
command -v uniq > /dev/null 2>&1 || { echo >&2 "Uniq'e ihtiyacım var ama kurulu değil. İptal ediliyor."; exit 1; }
...
printf "\e[1;92m _  | |https://instagram.com/marselian.pedro \e[0m\n"
printf "\e[1;92m( \ | | ____    ___  _| |_  _____           \e[0m\n"
printf "\e[1;92m ) )| ||  _ \  /___)(_   _)(____ |    \e[0m\n"
printf "\e[1;77m(_/ | || | | ||___ |  | |_ / ___ |  _____   \e[0m\n"
printf "\e[1;77m    |_||_| |_|(___/    \__)\_____| (Marselian Pedr0)  \e[0m\n"
printf "\n"
printf "\e[1;77m\e[45m   Instagram Brute Forcer v1.5 Author: Mars3li4n (Github/IG)   \e[0m\n"
printf "\n"
...
printf "\e[1;92mUse ./Pedroshell --resume\n"
else
exit 1
fi
else
